...
def print_logo ():#line:7:def print_logo():
    ...
    print ("   ╔══════════════════════════════════════════════════════════════╗")#line:10:print("   ╔══════════════════════════════════════════════════════════════╗")
    print ("   ║                   VOID X RAVEN TOOL                      ║")#line:11:print("   ║                   VOID X RAVEN  TOOL                      ║")
    print ("   ╚══════════════════════════════════════════════════════════════╝")#line:12:print("   ╚══════════════════════════════════════════════════════════════╝")
    print ("""
                           ⠄⠄⢀⣀⣤⣤⣴⣶⣶⣶⣶⣶⣶⣶⣶⣶⣶⣶⣶⣶⣤⣤⣄⣀⠄⠄
                        ⠄⠠⣿⢿⣿⢿⣯⣿⣽⢯⣟⡿⣽⢯⣿⣽⣯⣿⣽⣟⣟⣗⠄
    ...
    print ("   ╠══════════════════════════════════════════════════════════════════════╣")#line:25:print("   ╠══════════════════════════════════════════════════════════════════════╣")
    print ("   ║  👤 Coded By  : CYBER SOJIB                         ║")#line:26:print("   ║  👤 Coded By  : CYBER SOJIB                              ║")
    print ("   ║  🖊️ Author     : VOID X RAVEN                                    ║")#line:27:print("   ║  🖊️ Author     : VOID X RAVEN                                      ║")
    print ("   ║  🔗 Facebook  : https://www.facebook.com/share/165PM9vmfm/       ║")#line:28:print("   ║  🔗 Facebook  : https://www.facebook.com/share/165PM9vmfm/        ║")
    print ("   ║  📘 Team  Group: https://www.facebook.com/share/g/15yE5jBSuS/         ║")#line:29:print("   ║  📘 Team  Group : https://www.facebook.com/share/g/15yE5jBSuS/         ║")
    print ("   ║  🏛️ Team TELEGRAM : https://t.me/TEAMVOIDXRAVEN║")#line:30:print("   ║  🏛️ Team  TELEGRAM: https://t.me/TEAMVOIDXRAVEN ║")
    print ("   ╠══════════════════════════════════════════════════════════════════════╣")#line:31:print("   ╠══════════════════════════════════════════════════════════════════════╣")
...
def login ():#line:37:def login():
    ...
    while O0O0OO0000OO00O00 <3 :#line:44:while attempts < 3:
        ...
        if O0000000OOO000O00 =="cyber-sojib"and OO00OO00OO0OOO00O =="void-x-raven":#line:48:if username == "cyber-sojib" and password == "void-x-raven":
            print ("\n   ✅ Login Successful!\n")#line:49:print("\n   ✅ Login Successful!\n")
...
def print_ddos_banner ():#line:83:def print_ddos_banner():
    ...
    print ("   ╔══════════════════════════════════════════╗")#line:85:print("   ╔══════════════════════════════════════════╗")
    print ("   ║               VOID X RAVEN DDOS TOOL             ║")#line:86:print("   ║               VOID X RAVEN DDOS TOOL             ║")
    print ("   ╚══════════════════════════════════════════╝")#line:87:print("   ╚══════════════════════════════════════════╝")
    print ("\n")#line:88:print("\n")
    print ("███╗   ███╗██╗███╗   ██╗██╗    ██████╗ ██████╗  ██████╗ ███████╗")#line:89:print("███╗   ███╗██╗███╗   ██╗██╗    ██████╗ ██████╗  ██████╗ ███████╗")
    print ("████╗ ████║██║████╗  ██║██║    ██╔══██╗██╔══██╗██╔═══██╗██╔════╝")#line:90:print("████╗ ████║██║████╗  ██║██║    ██╔══██╗██╔══██╗██╔═══██╗██╔════╝")
